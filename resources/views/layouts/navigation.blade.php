<nav class="border-b border-gray-100 bg-white" x-data="{ open: false }">
    ...
    <div class="flex h-16 justify-between">
      <div class="flex">
        ...
        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
          ...
          <x-nav-link :href="route('back.posts.index')" :active="request()->routeIs('back.posts*')">
            Posts
          </x-nav-link>
        </div>
      </div>
  ...
  <div class="hidden sm:hidden" :class="{ 'block': open, 'hidden': !open }">
    <div class="space-y-1 pb-3 pt-2">
      ...
      <x-responsive-nav-link :href="route('back.posts.index')" :active="request()->routeIs('back.posts*')">
        Posts
      </x-responsive-nav-link>
    </div>
